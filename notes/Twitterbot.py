...
# The next cell will authenticate your bot based on your keys and tokens. See the [Tweepy 
tutorial](https://github.com/comp-journalism/UMD-J479V-J779V-Spring2016/blob/master/Weekly/Week_5/Tweepy-skeleton.ipynb) for more details. 
...
# The next cell has a number of essential functions that allow your bot to listen to the twitter stream and then respond. The assignment involves fleshing out the editorial 
logic of the bot and writing code in the sections marked "TODO".
...
def tweet_reply(status, tweet_to_reply_to):
    ...
    foo = ['http://www.humansofnewyork.com/post/125869847371/i-admired-her-from-afar-for-a-while-and', 
'http://www.humansofnewyork.com/post/38640617321/the-ghost-tehran-iran', 'http://www.humansofnewyork.com/post/94159334781/there-were-dozens-of-them-and-only-four-of-us', 
'http://www.humansofnewyork.com/post/94167715831/i-would-give-my-soul-if-i-could-fix-her-brain', 
'http://www.humansofnewyork.com/post/94211267196/i-worry-about-the-day-they-start-to-want-things']
...
class TwitterStreamListener(tweepy.StreamListener):
    ...
    def api_limit_checker(self):
        ...
        if time.time() - self.old_time > 900: 
            ...
            # The bot cannot tweet more than 140 times every 15 minutes (and you should REALLY consider not ever getting close to that as you may trigger Twitters spam 
detectors)
            # The threshold below is set much more conservatively. It will only let you tweet 5 times in a 15 minute window
            if self.api_count > 5:
                print ("Taking a break")
                # We put the code to sleep for 15-x minutes where x is the current time - old time (when the window started)... So if within 6 minutes we tweet more than 140 
times, then the script will halt for the next 15-6=9 minutes until a new window starts
...
def listen():
    ...
    # track_object filters the twitter stream to capture data, can provide a hashtag, word, or screenname amongths other things. See documentation at: 
